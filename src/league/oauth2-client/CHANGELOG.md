...
* Renamed `MichaelKaefer\OAuth2ClientForPrestashop17\League\OAuth2\Client\Provider\User` to `MichaelKaefer\OAuth2ClientForPrestashop17\League\OAuth2\Client\Entity\User`.
